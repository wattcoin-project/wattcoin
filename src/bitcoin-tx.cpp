...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " wattcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  wattcoin-tx [options] <hex-tx> [commands]  Update hex-encoded wattcoin transaction\n" +
            "or:     wattcoin-tx [options] -create [commands]   Create hex-encoded wattcoin transaction\n" +
            "\n";
