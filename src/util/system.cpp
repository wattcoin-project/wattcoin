...
const char * const BITCOIN_CONF_FILENAME = "wattcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Wattcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Wattcoin";
#else
    // Unix
    return pathRet / ".wattcoin";
#endif
#endif
}
