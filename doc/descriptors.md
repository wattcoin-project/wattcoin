# Support for Output Descriptors in Wattcoin Core

Since Wattcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Wattcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Wattcoin Core wallets, a convenience function `combo` is
