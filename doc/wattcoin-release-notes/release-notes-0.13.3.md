Wattcoin Core version 0.13.3 is now available from:

  <https://download.wattcoin.org/wattcoin-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/wattcoin-project/wattcoin/blob/0.13/src/chainparams.cpp#L214).
