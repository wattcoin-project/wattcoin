Wattcoin Core version *0.15.1* is now available from:

  <https://download.wattcoin.org/wattcoin-0.15.1/>
...
A number of changes to the way Wattcoin Core deals with peer connections and invalid blocks
