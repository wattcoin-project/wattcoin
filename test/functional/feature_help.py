...
"""Verify that starting wattcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start wattcoin with -h for help text")
        ...
        self.log.info("Start wattcoin with -version for version information")
        ...
        self.log.info("Start wattcoind with -fakearg to make sure it does not start")
